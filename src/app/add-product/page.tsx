...
import {useCommodityStore} from "@/service/query/comodity-query"
...
export default function AddCommodityForm() {
    ...
    const {mutate: doStoreComodity, isPending} = useCommodityStore()
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            ...
                                            value={field.value ? `Rp ${formatToRupiah(field.value)}` : ''} // Format the value
                                            onChange={(e) => {
                                                const rawValue = e.target.value.replace(/[^0-9]/g, ''); // Remove non-numeric characters
                                                field.onChange(rawValue ? parseFloat(rawValue) : 0); // Update the form field value
                                            }}
                                        />
                                    </FormControl>
                                    <FormDescription>
                        ...
                        return <FormField
                            ...
                            render={({field}) => (
                                <FormItem>
                                    ...
                                    <FormDescription>Masukkan luas area comodity dalam meter
                                        persegi.</FormDescription>
                                    <FormMessage/>
                                </FormItem>
                            )}
                        />;
    ...
    return (
        <Column className={'max-w-3xl mx-auto w-full'}>
            ...
            <Card className="w-full">
                <CardHeader>
                    <CardTitle>Tambah Comodity Baru</CardTitle>
                    <CardDescription>Isi formulir di bawah ini untuk menambahkan comodity baru.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
